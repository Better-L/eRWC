...
```{r create Figure 6, fig.width=12,fig.height=10}
fig6 <- (p1 + p2 + p3 + p4) + 
...
p_ranges_x <- c(ggplot_build(fig6[[1]])$layout$panel_scales_x[[1]]$range$range,
                ggplot_build(fig6[[2]])$layout$panel_scales_x[[1]]$range$range,
                ggplot_build(fig6[[3]])$layout$panel_scales_x[[1]]$range$range,
                ggplot_build(fig6[[4]])$layout$panel_scales_x[[1]]$range$range
                )

p_ranges_y <- c(ggplot_build(fig6[[1]])$layout$panel_scales_y[[1]]$range$range,
                ggplot_build(fig6[[2]])$layout$panel_scales_y[[1]]$range$range,
                ggplot_build(fig6[[3]])$layout$panel_scales_y[[1]]$range$range,
                ggplot_build(fig6[[4]])$layout$panel_scales_y[[1]]$range$range
                )
