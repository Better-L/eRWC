...
fig4 <- (cult_p_ord / ch_p_ord) + plot_annotation(tag_levels = "A") &
         theme(plot.tag = element_text(size = 18, face = "bold"))
ggsave(filename = file.path(getwd(), "..", "figures", "Figure_4.jpeg"), height = 10 , width = 10)
fig4   
```


```{r create Figure 4, fig.width=10,fig.height=5}
p_ord <-  cult_p_ord1 + theme(legend.direction = "vertical", legend.position = "right", legend.box = "horizontal")
fig4 <- ((p_ord / plot_spacer())) +
...
```{r create Figure 7, fig.width=18,fig.height=10}
p_ord <- ch_p_ord + theme(legend.direction = "vertical", legend.position = "bottom", legend.box = "horizontal")
fig7 <- ((p_ord / plot_spacer())) +
         plot_layout(ncol = 2, widths = c(2, 1)) + 
         plot_annotation(tag_levels = "A") &
         theme(plot.tag = element_text(size = 18, face = "bold"))
ggsave(filename = file.path(getwd(), "..", "figures", "Figure_7.jpeg"), height = 10 , width = 10 * 2)
fig7
```
